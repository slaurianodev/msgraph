...
from connect.graph_service import call_create_event_Calendar
...
def create_event():
    ...
    response = call_create_event_Calendar(session['access_token'],guest_email)
    ...
    session['pageRefresh'] = 'false'
    return render_template('main.html', alias=session['alias'],showSuccess=showSuccess, showError=showError)
